    ...
    <div className="py-12 container-fluid px-4 md:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="container-glass mb-10 p-6 rounded-xl">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center text-primary">دسته‌بندی‌ها</h1>
        ...
        <div className="mt-16">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-center text-primary">همه دسته‌بندی‌ها</h2>
